package learn.firstHeadJava.firstHeadJava_01;
...
//      这里学写了：
//      1、String[] wordListThree = {"24/7", "multiTier"};   String[] 赋值
//      2、int oneLength = wordListOne.length;               数组长度
//      3、int rand1 = (int) (Math.random() * oneLength);    随机数，强制类型转化

        String[] wordListOne = {"24/7", "multiTier", "30,000 foot", "B-to-B", "win-win", "frontend", "web-based", "pervasive",
